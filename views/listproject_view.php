        ...
        if (empty($allProjet)){ ?>
            <div class="container-home" style="width: 500px;">
                <p>
                    ...
                    Aucun projet existant dans votre liste
                </p>
            </div>
        <?php }else{
            foreach ($allProjet as $projet): ?>
                <div class="container-home-client">
                        <table>
                            <tr class="tr-accueil">
                                <th>Entreprise</th>
                                <th>Contact</th>
                            ...
                            <tr class="tr-accueil-data">
                                ...
                                <td><?= date_format(date_create($projet['deadline']),"d/m/Y") ?></td>
                                <td><?=  $projet['price'] ?></td>
                                <td><?=  $projet['priceHour'] ?></td>
                                <td><?=  $projet['nbHour'] ?></td>
                                <td><?=  date_format(date_create($projet['dateStart']),"d/m/Y") ?></td>
                                <td><?=  date_format(date_create($projet['dateEnd']),"d/m/Y") ?></td>
                                <td><?=  $projet['state'] ?></td>
                                <td><a href=<?= "_functions/fnc_deleteProjet.php?id=".$projet['idP'] ?>>delete</a></td>
                            </tr>
                        </table>
                    </div>
            <?php endforeach;
